...
| `migrations/011_pagination_indexes.sql` | `tenant_kaufnest.*` | ⏳ **pending** — 2 new indexes on `audit_logs (created_at desc)` and `products (name asc)` for efficient pagination range queries |
